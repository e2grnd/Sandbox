...
(function (GLOBAL, $) {
    ...
    var TEMPLATE_START_GROUP = '<div class="pv-collapsable-content EXPANDED"><div class="pv-collapse-title pv-collapsable-action clickable">' +
        ...
        "<label class='vtk-icon-ok scalar-range-button btn btn-default btn-xs' data-action='rescale-to-custom' data-toggle='tooltip' data-placement='bottom' title='Apply Color Range' id='customLegendScale'></label>" +
        "</div></div></div>" +
