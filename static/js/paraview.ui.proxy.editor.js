...
(function (GLOBAL, $) {
    ...
    var TEMPLATE_START_GROUP = '<div class="pv-collapsable-content EXPANDED"><div class="pv-collapse-title pv-collapsable-action clickable">' +
        ...
        //"CAN_DELETE" +
        "<span class='float-right button-padding-left clickable' data-action='apply-property-values' data-toggle='tooltip' data-placement='bottom' title='Apply Properties'><div color='white'>APPLY</div></span>" +
        "</div>" +
        "PROPERTIES",
